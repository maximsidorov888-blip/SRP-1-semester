...
# Пример 1 система ассимптотически устойчива (0 < K1 < 1)
fig1, ax1, traj1 = plot_dpll_map(K1=0.75, initial_fi=2.75, num_iterations=1200)
plt.show()

# Пример 2 система ассимптотически устойчива (1 < K1 < 2)
fig2, ax2, traj2 = plot_dpll_map(K1=1.85, initial_fi=1.25, num_iterations=1200)
plt.show()

# Пример 3 система ассимптотически неустойчива - глобально устойчивый цикл периода 2 (2 < K1 < п)
fig3, ax3, traj3 = plot_dpll_map(K1=2.6, initial_fi=1.90, num_iterations=1200)
plt.show()

# Пример 4 система ассимптотически неустойчива - два локально устойчивых цикла периода 2 (2 < K1 < п)
fig4, ax4, traj4 = plot_dpll_map(K1=3.3, initial_fi=1.40, num_iterations=1200)
plt.show()

# Пример 5 система ассимптотически неустойчива - два локально устойчивых цикла периода 4 ((п**2 + 2)**0.5 < K1 < 3.5123)
fig5, ax5, traj5 = plot_dpll_map(K1=3.488, initial_fi=1.90, num_iterations=1200)
plt.show()

# Пример 6 система ассимптотически неустойчива - хаос (K1 > 4.6)
